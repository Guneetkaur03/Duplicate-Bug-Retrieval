...
class Net(nn.Module):
	...
	def __init__(self):
		...
		self.RNN = nn.GRU(input_size=word_dim, hidden_size=50, bidirectional=False, batch_first=True)


		self.attention_layer = Attention(50, 50)
	...
	def forward(self, x):
		...
		out   = self.attention_layer(hidden, out)
